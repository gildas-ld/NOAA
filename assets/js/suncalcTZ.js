...
var suncalc = createCommonjsModule(function (module, exports) {
  (function () {
    ...
    function eclipticLongitude(M) {
      var C = rad * (1.9148 * sin(M) + 0.02 * sin(2 * M) + 3e-4 * sin(3 * M)), // equation of center
        P = rad * 102.937348; // perihelion of the Earth
      return M + C + P + PI;
    }
    ...
    SunCalc.addTime = function (angle, riseName, setName) {
      times2.push([angle, riseName, setName]);
    };
    var J0 = 9e-4;
    ...
    SunCalc.getTimes = function (date, lat, lng, height) {
      var tz = SunCalc.tzlookup(lat, lng);
      height = height || 0;
      var lw = rad * -lng,
        phi = rad * lat,
      ...
      for (i = 0, len = times2.length; i < len; i += 1) {
        time = times2[i];
        h0 = (time[0] + dh) * rad;
      ...
      for (let time2 in result) {
        ...
        result[time2] = new Date(
          Date.parse(
            new Intl.DateTimeFormat("default", options).format(result[time2]),
          ),
        );
      }
      return result;
    ...
    SunCalc.getMoonIllumination = function (date) {
      var d = toDays(date || new Date()(Date.now())),
        s = sunCoords(d),
        m = moonCoords(d),
        sdist = 149598e3,
        phi = acos(
...
var addTime = suncalc.addTime;
export default suncalc;
var getMoonIllumination = suncalc.getMoonIllumination;
var getMoonPosition = suncalc.getMoonPosition;
var getMoonTimes = suncalc.getMoonTimes;
var getPosition = suncalc.getPosition;
var getTimes = suncalc.getTimes;
var times = suncalc.times;
var tzlookup = suncalc.tzlookup;
export {
  suncalc as __moduleExports,
  addTime,
  getMoonIllumination,
  getMoonPosition,
  getMoonTimes,
