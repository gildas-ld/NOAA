  ...
  var t = l.Marker.extend({
    ...
    e = t.extend({
      ...
      _getIconSVG: function (t, i) {
        var o = t.radius,
          s = t.width + t.weight,
          o = 2 * (o + t.depth + t.weight),
          t = "M0,0 l" + t.width / 2 + "," + t.depth + " l-" + s + ",0 z";
        return {
    ...
    e = l.Control.extend({
      options: {
        ...
        createButtonCallback: function (t, i) {
          ...
          (o.title = i.strings.title), (o.role = "button"), (o.href = "#");
          t = l.DomUtil.create(i.iconElementTag, i.icon, o);
          return (
            void 0 !== i.strings.text &&
              ...
              0 < i.icon.length && t.classList.add("leaflet-locate-icon")),
            { link: o, icon: t }
          );
        },
      ...
      onAdd: function (t) {
        ...
        t = this.options.createButtonCallback(i, this.options);
        return (
          (this._link = t.link),
          (this._icon = t.icon),
          l.DomEvent.on(
      ...
      _onClick: function () {
        ...
        if (
          ...
          switch (
            (o = i[
              (o = this._map.getBounds().contains(this._event.latlng)
                ? t
                  ? i.inView
                  : i.inViewNotFollowing
                : o)
            ]
              ? i[o]
              : o)
      ...
      _activate: function () {
        ...
        this._active ||
          ...
          !this.options.showCompass ||
            (((t = "ondeviceorientationabsolute" in window) ||
          ...
          this._isOutsideMapBounds()
            ...
            : this._justClicked && !1 !== this.options.initialZoomLevel
              ...
              : this.options.keepCurrentZoomLevel
                ? (t = this.options.flyTo
                    ? this._map.flyTo
                    : this._map.panTo).bind(this._map)([
      ...
      _drawMarker: function () {
        ...
        this.options.drawCircle &&
          ((t = this._isFollowing()
            ...
            : this.options.circleStyle),
          this._circle
            ? this._circle.setLatLng(e).setRadius(s).setStyle(t)
            : (this._circle = l.circle(e, s, t).addTo(this._layer))),
          (o = this.options.metric
            ? ((i = s.toFixed(0)), this.options.strings.metersUnit)
          ...
          this.options.drawMarker &&
            ...
            this._marker
              ? (this._marker.setLatLng(e),
                this._marker.setStyle && this._marker.setStyle(s))
              : (this._marker = new this.options.markerClass(e, s).addTo(
                  this._layer,
                ))),
          this._drawCompass();
        var n = this.options.strings.popup;
        function a() {
          return "string" == typeof n
            ? l.Util.template(n, { distance: i, unit: o })
            : "function" == typeof n
              ? n({ distance: i, unit: o })
              : n;
        }
        this.options.showPopup &&
          n &&
          this._marker &&
          this._marker.bindPopup(a())._popup.setLatLng(e),
          this.options.showPopup &&
            n &&
            this._compass &&
            this._compass.bindPopup(a())._popup.setLatLng(e);
      },
